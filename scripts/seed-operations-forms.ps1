...
function Options($pairs) {
    # Not an HTTP body itself - becomes the optionsJson field VALUE, sent through
    # Invoke-JsonPost by whichever Add-Field call uses it, so no separate fix needed here.
